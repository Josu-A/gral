Emandako `nums` zenbaki osoen array bat eta `target` zenbaki oso bat, itzuli `target` batuketa ematen duten bi zenbakien _indizeak_.

Suposa dezakezu sarrera bakoitzak **zehazki soluzio bakarra** duela, eta ezin duzu _elementu_ bera birritan erabili.
